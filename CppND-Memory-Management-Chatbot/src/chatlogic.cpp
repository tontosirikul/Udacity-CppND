...
ChatLogic::~ChatLogic()
{
    ...
    // Apllied submission review to fix the bug
    // delete _chatBot;

    // Task 3 _nodes has become smart pointer, no need to delete
    // // delete all nodes
    ...
    // delete all edges
    // Task 4 after edge was apllied with smart pointer, no need to delete by operator
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // Task 3 applied smart pointer before add to vector
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // create new edge
                            // Task 4 make it to become smart pointer and initialized with id
                            ...
                            // Task 4 give edge pointer by get
                            (*childNode)->AddEdgeToParentNode(edge.get());
                            // Task 4 transfer/change ownership
    ...
    // Task 5 replace chatbot to local here
    // create instance of chatbot
